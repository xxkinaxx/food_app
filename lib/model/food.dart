...
class Food extends Equatable{
  ...
  @override
  List<Object?> get props => [id, name, picturePath, description, ingredients, price, rate];
}
...
List<Food> mockFoods = [
  Food(
    ...
    ingredients: 'daging ayam/sapi, tusuk sate, kecap manis, bawang putih, bawang merah, ketumbar, gula merah, kacang tanah, daun jeruk, air jeruk limau, garam, air',
    price: 150000,
    rate: 4.2,
  ),
  Food(
    ...
    ingredients: 'nasi putih, bawang putih, bawang merah, kecap manis, kecap asin, telur, ayam/sosis/udang, cabai, garam, merica, minyak goreng, acar, kerupuk',
    price: 25000,
    rate: 4.5,
  ),
  Food(
    ...
    ingredients: 'mie telur, ayam fillet, jamur kancing, bawang putih, bawang merah, kecap manis, kecap asin, saus tiram, minyak wijen, garam, daun bawang, kaldu ayam',
    price: 20000,
    rate: 4.7,
  ),
  Food(
    ...
    ingredients: 'daging sapi giling, tepung tapioka, bawang putih, bawang merah goreng, garam, merica, telur, daging cincang untuk isi, kuah kaldu sapi, mie kuning, bihun, sawi, tahu',
    price: 30000,
    rate: 4.3,
  ),
  Food(
    ...
    ingredients: 'ayam kampung, cabai merah, bawang putih, bawang merah, terasi, gula merah, air asam jawa, santan, garam, kemiri, minyak goreng, jeruk limau',
    price: 50000,
    rate: 4.8,
  ),
  Food(
    ...
    ingredients: 'sayur-sayuran (kol, bayam, tauge, kacang panjang), tahu, tempe, telur rebus, lontong, kacang tanah, bawang putih, cabai, gula merah, air asam jawa, garam, kerupuk, emping',
    price: 20000,
    rate: 4.6,
  ),
  Food(
    ...
    ingredients: 'cendol hijau, durian, santan, gula merah cair, es serut, air daun pandan, tepung hunkwe, garam, nangka (opsional)',
    price: 25000,
    rate: 4.4,
  ),
];